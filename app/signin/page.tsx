  ...
  const handleSignin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (data.message === "Please verify OTP first") {
      ...
      >
        <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 font-medium">Log in to your ShaadiSthal account</p>
          </div>
          ...
          <form onSubmit={handleSignin} className="space-y-6">
            ...
            <div className="flex items-center justify-end">
              {/* Forgot password link removed as it doesn't exist yet */}
            </div>
