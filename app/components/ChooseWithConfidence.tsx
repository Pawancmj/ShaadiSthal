...
export default function ChooseWithConfidence(): React.ReactElement {
  return (
    <section className="home-section" style={{
      ...
      <div className="confidence-layout" style={{ display: "flex", gap: 60, alignItems: "center", flexWrap: "wrap" }}>
        ...
        {/* Right – Compare Card */}
        <div className="confidence-card-wrap" style={{ flex: 1, minWidth: 300 }}>
          <div className="confidence-card" style={{
            ...
            {/* Photos */}
            <div className="confidence-card__photos" style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 12 }}>
            ...
            {/* Rows */}
            {rows.map((row) => (
              <div className="confidence-card__row" key={row.label} style={{
